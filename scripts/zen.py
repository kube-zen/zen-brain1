...
Config-driven via config/clusters.yaml; uses 127.0.1.x and zen-registry:5000.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Zen-brain deployment CLI (config-driven, 127.0.1.x, zen-registry:5000)",
    )
