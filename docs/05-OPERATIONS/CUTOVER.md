...
- [x] Block 0.5: SDK package audit (see [COMPLETENESS_MATRIX.md](../01-ARCHITECTURE/COMPLETENESS_MATRIX.md) and Block 0.5 in [CONSTRUCTION_PLAN.md](../01-ARCHITECTURE/CONSTRUCTION_PLAN.md); reuse 100% (retry, scheduler, receiptlog, health, dedup, store, observability, logging, events, crypto, dlq all imported and wired))
