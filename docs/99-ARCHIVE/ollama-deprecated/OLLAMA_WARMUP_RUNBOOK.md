# Ollama warmup runbook — **DEPRECATED — FORBIDDEN**

> ⛔ **STOP: Ollama is DEPRECATED and FORBIDDEN for zen-brain1.**
> This document is preserved for historical reference only. Do NOT follow these instructions.
> Primary inference uses **llama.cpp** (L1/L2). See [SMALL_MODEL_STRATEGY.md](../../03-DESIGN/SMALL_MODEL_STRATEGY.md).
>
> This file should be moved to `docs/99-ARCHIVE/` on next cleanup pass.
...
| **Operator Runbook** | Troubleshooting and verification commands | [ZB_023_LOCAL_CPU_INFERENCE_RULE.md](../../05-OPERATIONS/ZB_023_LOCAL_CPU_INFERENCE_RULE.md) |
