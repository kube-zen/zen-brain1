...
func (r *WorkTypeTemplateRegistry) registerBugFixTemplates() {
	...
	template := &WorkTypeTemplate{
		...
		Steps: []ExecutionStepTemplate{
			...
			{
				Name:        "Run tests",
				Description: "Execute tests to verify fix works (real go test when go.mod present)",
				Variables:   map[string]string{},
				Timeout:     180,
				MaxRetries:  1,
			},
	...
	template := &WorkTypeTemplate{
		...
		Steps: []ExecutionStepTemplate{
			...
			},
			{
				...
				Description: "Verify refactoring preserves behavior (real go test when go.mod present)",
				Variables:   map[string]string{},
				Timeout:     180,
				MaxRetries:  1,
			},
...
func (r *WorkTypeTemplateRegistry) registerTestTemplates() {
	template := &WorkTypeTemplate{
		...
		Steps: []ExecutionStepTemplate{
			...
			{
				Name:        "Run tests",
				Description: "Run test suite and collect results (real go test when go.mod present)",
				Variables:   map[string]string{},
				Timeout:     180,
				MaxRetries:  1,
			},
